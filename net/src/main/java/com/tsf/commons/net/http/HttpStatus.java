// Original source: https://github.com/spring-projects/spring-framework/blob/master/spring-web/src/main/java/org/springframework/http/HttpStatus.java
...
package com.tsf.commons.net.http;
...
public enum HttpStatus {
	...
	/**
	 * @return Whether this status code is in the HTTP series Informational
	 * Whether this status code is in the HTTP series
	 * {@link com.tsf.commons.net.http.HttpStatus.Series#INFORMATIONAL}.
	...
	/**
	 * @return Whether this status code is in the HTTP series Successful
	 * Whether this status code is in the HTTP series
	 * {@link com.tsf.commons.net.http.HttpStatus.Series#SUCCESSFUL}.
	 * This is a shortcut for checking the value of {@link #series()}.
	 */
	...
	/**
	 * @return Whether this status code is in the HTTP series Redirection
	 * Whether this status code is in the HTTP series
	 * {@link com.tsf.commons.net.http.HttpStatus.Series#REDIRECTION}.
	 * This is a shortcut for checking the value of {@link #series()}.
	 */
	...
	/**
	 * @return Whether this status code is in the HTTP series Client Error
	 * Whether this status code is in the HTTP series
	 * {@link com.tsf.commons.net.http.HttpStatus.Series#CLIENT_ERROR}.
	 * This is a shortcut for checking the value of {@link #series()}.
	 */
	...
	/**
	 * @return Whether this status code is in the HTTP series Server Error
	 * Whether this status code is in the HTTP series
	 * {@link com.tsf.commons.net.http.HttpStatus.Series#SERVER_ERROR}.
	 * This is a shortcut for checking the value of {@link #series()}.
	 */
	 ...
	 * @return Return the enum constant of this type with the specified numeric value.
